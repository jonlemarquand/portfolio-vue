            ...
            gridData: [
                {
                    ...
                    github: "https://github.com/jonlemarquand/chord-theory",
                ...
                },
                {
                    ...
                    infoText: ["Transparency International UK (TI-UK) are the UK chapter of the global anti-corruption charity… Transparency International. As part of their work they have the Business Integrity Programme, which is designed to work with businesses to improve their anti-corruption efforts. One of the ways they do this is to provide anti-bribery guidance through their website: antibriberyguidance.org. Although this website was initially developed in 2017 by an external company, they recently wanted it to be updated to include various bribery legislations from different countries, along with a refresh of the homepage.", "The site itself is built in Drupal 7, and so any modifications needed to be built into that framework that existed. This required building a new content type into the existing type for the bribery legislation pages, as well as editing some of the php templates.", "One of the most interesting things about the redesign was the use of a 3D Globe on the homepage to display where relevant bribery legislation was located. To build this I used three.js, learning it for the work above. I have written more about my experience learning three.js here.", "Overall, the homepage and new content gave the site a fresh feel, and allowed Transparency International UK to market the site with the updated content on, drawing more visitors to the site and further establishing their reputation as a knowledge hub for anti-corruption."],
                ...
                },
                {
                    ...
                    infoText: ["MPs are public figures, who need to be seen to be doing something. So when a new parliamentary staffer started with Adrian Bailey in 2017, they quickly realised that Mr. Bailey didn’t have a website at the time and this needed to be fixed! So I was brought on to design a website that would be able to showcase the work Mr. Bailey was doing for the community of West Bromwich West, gives times of surgeries where he could be met, allow people to sign up for a mailing list, as well as check that they were his MP before emailing him about casework. The website would also need to be easily-updated by a staff member, thus needed an easy CMS to use that could be quickly updated.","One of the biggest challenges was using imagery, as photo opportunities, despite being important for MPs, had previously been few and far between for Mr. Bailey. Therefore, we decided to create a slider with his campaign promises, along with an accompanying photo. This hero section provided the opportunity to use impactful imagery, despite only being a limited number.","A feature that was developed for the site was a ‘Who is my MP?’ section, as MPs are only allowed to take on casework of their own constituents. To check this, the plan was originally to use an external API, however, due to budget constraints, was scaled back to a more simple list of postcodes that were in West Bromwich West.","Overall, it was a successful website that allowed constituents to get in touch with Adrian easier and see what he was doing for them.","Note: Adrian Bailey is now no longer the MP for West Bromwich West having decided to step down at the December 2019 election, thus the site is no longer live, having previously been updated around July 2018."],
                    stack: ["Wordpress"],
                    filterStack: ["PHP", "SQL"],
                ...
                },
                {
                    id: 9,
                    title: "TI-UK Reports",
                    infoText: ["Transparency International UK (TI-UK) are the UK chapter of the global anti-corruption charity… Transparency International. Their main output, to enable them to further their goals of stopping corruption has been research and evidence-based reports which have needed designing. When I initially joined the charity in 2017, they were currently just being produced in Microsoft Word, which whilst definitely capable of putting words on a page, didn’t help expand the brand of TI-UK as much as possible.","Although, designing reports can often be straight forward, one of the hardest things has often been agreeing a stand out cover image for the report with the teams involved. It has often been considered One of the many highlights of this process was undoubtedly seeing Hiding in Plain Sight featured on the BBC’s news website complete with the designed front cover.","During my time with Transparency International UK I have designed over 20 publications. The quality of the work has been praised by external readers, donors and people within the organisation, suggesting that the layouts and design of the reports has definitely been a cause in increasing the reading of them, and thus furthering the causes of Transparency International."],
                ...
                },
                {
                    ...
                    infoText: ["Every year Transparency International UK host an anti-corruption lecture, with speakers such as former Prime Minister David Cameron. In 2018, they were celebrating 25 Years of Transparency International and wanted an exhibition outside the lecture theatre commemorating some of their achievements during this time. It was a big challenge, literally, as I had previously only really produced print design for around A4/A5 sizes.", "The TI-UK brand is fairly straightforward, 2 fonts, a TI Blue, black and white with the addition of the yellow from the TI25 Logo they had commissioned. Although I had initially had the designs printed off in A4, I then took to printing off full sized posters on A4 sheets, to see what the design looked like larger. It was here that I realised that enough space was needed to keep the designs at eye level, rather than leaving people straining to see the bottom text.", "I was glad I did this as once we arrived at the venue to put up the exhibition, we realised a slight problem. The sizes given to a colleague for the board measured the entire board, including the wheels. Thankfully, because the posters were designed with a large blue footer section, we could just fold them over so they were the appropriate size and all was well.", "Having never designed anything to that scale and size, I was really pleased with how they came out and I received great feedback from both colleagues and guests at the lecture. What did I learn for next time? Always be crystal-clear on what sizes you are asking for and always check the image resolution. Never settle for blurry!"],
                    stack: ["Print"],
                ...
                },
                {
                    id: 12,
                    title: "Portfolio",
                    infoText: ["A web developer’s portfolio is often the hardest thing to get right. Everyone is aware that it’s a means to an end, in displaying the projects and code worked on, but with an opportunity to show a personal flare and style. To that end, this portfolio went through several iterations before settling on using a simple React App to display projects in a modal, along with an about, a blog and a contact form."],
                    stack: ["Vue"],
                    filterStack: ["Vue"],
    ...
    computed: {
        modalData: function() {
            ...
            const newModalData = {
                ...
                infoText: this.gridData[this.modalID].infoText,
                stack: newStack,
...
<style lang="scss" scoped>
    ...
    .portfolio-grid {
        ...
        @media (max-height: 921px) and (min-width: 600px) {
